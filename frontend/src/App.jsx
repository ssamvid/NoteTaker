...
function App() {
  // Week 4: notes are fetched from the Express/MongoDB API instead of a hardcoded array.
  ...
  // Fetch notes from the API once on mount.
  useEffect(() => {
    notesApi
      .fetchNotes()
      .then(setNotes)
      .catch(() => setLoadError('Could not load notes. Is the API running?'))
      .finally(() => setIsLoading(false))
  }, [])

  // Side effect: log the note count to the console whenever it changes.
  useEffect(() => {
